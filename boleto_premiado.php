...
<body>
    <section class="container">
        ...
        <br><br>
        <h3>Ingrese el número de boleto premiado, junto a su respectiva fecha</h3>
        <br><br>

        <form action="premiados.php" method="POST">
            <input type="text" placeholder="Nº boleto" name="boleto">
            <br><br>
            <input type="date" placeholder="Fecha del sorteo" name="fecha_sorteo">
            <br><br>

            <input type="submit" value="Guardar" name="enviar_premiados">
        </form>
        <br><br><br><br>
